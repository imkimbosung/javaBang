...
var idCheckCnt = 0;
 ...
 <div class="col-lg-5" style="margin:auto;margin-top:50px;">
	...
	<ol class="breadcrumb" style="">
		...
		<form name="proRegisterJoin1" method="post" id="realtorDTO" action="${ctRealtorRoot}/proRegisterJoin2.do" enctype="multipart/form-data">
			<table class="table">
				...
				<tr>
					...
					<td ><input type="text" placeholder="김공인중개사" size="14" maxlength="10" name="r_name" >
				...
				<tr>
					...
					<td><input type="text" placeholder="123" size="20" maxlength="25" name="r_phone">
				<tr>
