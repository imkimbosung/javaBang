...
<script type="text/javascript">
	...
	function checkLoginForm() {
		...
		$.ajax({
			url : "${ctRealtorRoot}/forgetRealtorPwdProc.do"
			,type : "post"
			,data : $("[name=forgetRealtorPwd]").serialize()
			,success : function(realtorPwdGet) {
				
				
				if (realtorPwdGet!=null) {
					alert("비밀번호는" + realtorPwdGet.realtorPwd + "입니다");
					MovePage();
				} else if (realtorPwdGet == null) {
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				...
				<!-- ======================================================= -->
				<form name="forgetRealtorPwd" class="login100-form validate-form flex-sb flex-w"  method="post" id="realtorDTO" action="${ctRealtorRoot}/forgetRealtorPwdProc.do" >
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Username is required">
						<input class="input100" type="text" name="r_id" placeholder="아이디"> <span class="focus-input100"></span>
					</div>
