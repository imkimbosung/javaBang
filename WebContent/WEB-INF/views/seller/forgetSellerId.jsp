...
<script type="text/javascript">
	...
	function checkLoginForm() {
		...
		if (is_empty("[name=s_jumin2]")) {
			alert("주민번호 뒷자리 입력 요망");
			$('[name=s_jumin2]').val("");
			return;
		}
		$.ajax({
			url : "${ctSellerRoot}/forgetSellerIdProc.do"
			,type : "post"
			,data : $("[name=forgetSellerId]").serialize()
			,success : function(sellerIdGet) {
				if (sellerIdGet!=null) {
					alert("아이디가 존재합니다.아이디는" + sellerIdGet.sellerId + "입니다");
					MovePage();
					
				} else if (sellerIdGet == null) {
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<!-- ======================================================= -->
				<form name="forgetSellerId" class="login100-form validate-form flex-sb flex-w"  method="post" id="sellerSignupDTO" action="${ctSellerRoot}/forgetSellerIdProc.do" >
					<span class="login100-form-title p-b-51">팔아방 아이디찾기</span>
