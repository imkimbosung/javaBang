...
<script type="text/javascript">
	...
	function checkLoginForm() {
		...
		$.ajax({
			url : "${ctRentalRoot}/forgetRentalIdProc.do"
			,type : "post"
			,data : $("[name=forgetRentalId]").serialize()
			,success : function(rentalIdcnt) {
				
				
				if (rentalIdcnt!=null) {
					alert("아이디가 존재합니다.아이디는" + rentalIdcnt.rentalId + "입니다");
					MovePage();
				} else if (rentalIdcnt == null) {
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				...
				<!-- ======================================================= -->
				<form name="forgetRentalId" class="login100-form validate-form flex-sb flex-w" >
					<span class="login100-form-title p-b-51">렌탈업체 아이디찾기</span>
					...
					<div class="wrap-input100 validate-input m-b-16"
						...
						<input class="input100" type="password" name="rt_bnum" placeholder="사업자번호 '-'빼고 입력"> <span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-16"
						data-validate="Password is required">
						<input class="input100" type="text" name="rt_phone" placeholder="전화번호 '-'빼고 입력"> <span class="focus-input100"></span>
					</div>
